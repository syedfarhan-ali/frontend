    ...
    <div className="container ">
      ...
      >
        ...
        <div className="col-6 p-3">
          ...
          <p>Connect on <a href="#" style={{textDecoration:"none"}}>Homepage</a> / <a href="#" style={{textDecoration:"none"}}>TradingQnA</a> / <a href="x.com" style={{textDecoration:"none"}}>Twitter</a></p>
        </div>
      </div>
    </div>
  );
