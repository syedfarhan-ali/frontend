      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col" >
            ...
            <br />
            <a href="" style={{textDecoration:'none'}} className="text-muted">Zerodha cares</a>
            <br />
          </div>
          <div className="col">
            <p>Support</p>
        ...
        <div className="text-center text-muted" >
            ...
            <a href="" style={{textDecoration:'none'}} className="text-muted">Policies & procedures </a>
            <a href="" style={{textDecoration:'none'}} className="text-muted">Privacy Policy </a>
            <a href="" style={{textDecoration:'none'}} className="text-muted">Disclosure </a>
        </div>
      </div>
    </footer>
  );
